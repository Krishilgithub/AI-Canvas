    ...
    constructor() {
        ...
        this.triggerPost = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (post.status !== constants_1.PostStatus.APPROVED &&
                    post.status !== constants_1.PostStatus.SCHEDULED &&
                    post.status !== constants_1.PostStatus.NEEDS_APPROVAL &&
                    post.status !== constants_1.PostStatus.FAILED) {
                    return res
                        .status(400)
                ...
                try {
                    if (platform === 'twitter') {
                        ...
                        resultId = ((_c = tweetRes === null || tweetRes === void 0 ? void 0 : tweetRes.data) === null || _c === void 0 ? void 0 : _c.id) || (tweetRes === null || tweetRes === void 0 ? void 0 : tweetRes.id) || "twitter_unknown_id";
                    }
                        ...
                        const redditRes = yield reddit_service_1.redditService.postToReddit(user_id, post.content);
