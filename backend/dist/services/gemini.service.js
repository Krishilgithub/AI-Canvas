...
If the input data is weak or insufficient, return fewer but high-confidence trends instead of low-quality results.`;
    ...
    // ─────────────────────────────────────────────────────────────────────────
    analyzeTrendPotential(articles) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.model)
...
${articles.map((a, i) => `${i}: ${a.title}`).join("\n")}`;
    ...
    // ─────────────────────────────────────────────────────────────────────────
    fallbackAnalysis(articles, genre) {
    ...
    generateDraft(topic, context, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.model)
                return `[Draft] Insights on ${topic}. ${context}`;
            try {
