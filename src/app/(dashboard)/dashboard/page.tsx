      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Welcome back, Krishil. Here&apos;s what&apos;s happening today.
          </p>
        </div>
        <Button>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          ...
          },
          {
            ...
            value: m.pending_approvals?.toString() || "0",
          ...
          },
          {
            ...
            value: m.published_this_week?.toString() || "0",
            change: "Target: 5",
            icon: CheckCircle2,
              ...
              activity.map((item: any, i: number) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`h-2 w-2 rounded-full ${item.status === "needs_approval" ? "bg-amber-500" : item.status === "published" ? "bg-green-500" : "bg-secondary"}`}
                    />
                    <div>
