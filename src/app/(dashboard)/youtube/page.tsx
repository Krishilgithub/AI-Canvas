...
export default function YouTubePage() {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage videos, analyze niche trends, and auto-schedule uploads.
          </p>
        </div>
        <div
      ...
      {/* Passing platform prop filter */}
      {activeTab === "approval" && <ContentApproval platform="youtube" />}
...
function TrendsView() {
  ...
  useEffect(() => {
    setLoading(true);
    fetcher(
      `/trends?page=${page}&limit=10&category=${category}&platform=youtube`,
    )
      .then((res) => {
  ...
  return (
    <div className="space-y-6" suppressHydrationWarning>
      ...
      >
        <Card className="bg-gradient-to-br from-primary/5 to-transparent border-primary/10">
          ...
          <CardContent>
            <div className="text-xs text-muted-foreground">
              Trending video ideas align with your channel.
            </div>
          </CardContent>
        </Card>
        <Card>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardDescription>Next Upload</CardDescription>
            <CardTitle className="text-2xl">Tomorrow</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-xs text-muted-foreground">
              &quot;How to use AI for Productivity&quot; (Description)
            </div>
          </CardContent>
        </Card>
      </div>
        ...
        <CardHeader className="pb-2">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <CardDescription>
                Topics currently gaining velocity on YouTube.
              </CardDescription>
            ...
            <div className="flex gap-2">
              <Button
                ...
                onClick={() => {
                  toast.promise(
                    poster("/seed", { platform: "youtube" }).then(() =>
                  ...
                  trends.map((row, i) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        ...
                        >
                          <Sparkles className="mr-2 h-3 w-3" /> Draft Idea
                        </Button>
                      </td>
                    </tr>
                  ))
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Log of all actions taken by the AI agent for YouTube.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          {[
            {
              action: "Uploaded 'Tech Trends 2025' (Scheduled)",
              time: "2 hours ago",
              status: "Success",
            },
            {
              action: "Optimized Metadata for 'iPhone 16 Review'",
              time: "1 day ago",
              status: "Success",
            },
          ].map((log, i) => (
